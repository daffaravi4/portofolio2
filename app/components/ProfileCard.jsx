...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#2E2E2E 0%, #424242 55%, #5A5A5A 100%)';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(66,66,66,0.45)',
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
     className="grid relative overflow-hidden backface-hidden h-[44svh] lg:h-[80svh]"
  style={{
    maxHeight: '540px',
    aspectRatio: '0.718',
            borderRadius: cardRadius,
